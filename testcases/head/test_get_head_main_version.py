...
cases = get_test_data_from_excel(TuyaRobotBase.HEAD_TEST_DATA_FILE, "get_head_main_version")

@allure.feature("头部 PI4")
@allure.story("get_head_main_version")
@pytest.mark.head
...
def test_get_head_main_version(head, case):
    ...
    with allure.step("调用 get_head_main_version 接口"):
        actual = head.get_head_main_version()
